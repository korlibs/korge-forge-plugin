...
inline fun <reified T> ComponentManager.getService(): T = getService(T::class.java)

fun <T> getService(clazz: Class<T>): T = ApplicationManager.getApplication().getService(clazz)

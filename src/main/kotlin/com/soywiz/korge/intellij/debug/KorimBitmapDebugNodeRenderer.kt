...
class KorimBmpSliceDebugNodeRenderer : BaseKorimBitmapDebugNodeRenderer(RectSlice::class)
class KorimDrawableDebugNodeRenderer : BaseKorimBitmapDebugNodeRenderer(Drawable::class)
class KorimKorgeViewImageDebugNodeRenderer : BaseKorimBitmapDebugNodeRenderer(Image::class)

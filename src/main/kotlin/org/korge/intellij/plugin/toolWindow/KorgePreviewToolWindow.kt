...
object KorgePreviewTool {
    fun play(e: AnActionEvent, ipc: KorgeIPCInfo? = null, panel: KorgeForgeIPCJPanel? = null) {
        ...
        */
        ...
        val settings = createGradleRunConfiguration(project, "runJvmAutoreload -Pkorge.headless=true \"-Pkorge.ipc=${ipcPath}\" -Pkorge.ipc.version=2", name = "run (preview)", select = false) {
